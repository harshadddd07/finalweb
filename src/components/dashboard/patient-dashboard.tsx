...
const quickLinks = [
    { href: "/billing?role=patient", label: "View Billing", icon: CreditCard },
    { href: "/profile?role=patient", label: "Manage Profile", icon: User },
    { href: "/emergency?role=patient", label: "Emergency", icon: ShieldAlert },
]

export default function PatientDashboard() {
  return (
    <div className="flex flex-col gap-4 md:gap-8">
      <h1 className="text-3xl font-bold font-headline">Welcome Back, Aarav!</h1>
              ...
              <Card>
                  ...
                  <CardFooter>
                        <Button asChild className="w-full">
                          <Link href="/appointments?role=patient">Schedule Now</Link>
                      </Button>
                  </CardFooter>
              </Card>
              <Card>
                  ...
                  <CardContent>
                    ...
                    <CardFooter>
                        <Button asChild className="w-full" variant="secondary">
                          <Link href="/chat?role=patient">Start Chat</Link>
                      </Button>
                  </CardFooter>
              </Card>
              <Card className="md:col-span-2">
                  ...
                  <CardFooter>
                        <Button asChild className="w-full" variant="outline">
                          <Link href="/symptom-analyzer?role=patient">Launch Tool</Link>
                      </Button>
                  </CardFooter>
              </Card>
          </div>
          ...
          <div className="lg:col-span-1 flex flex-col gap-8">
              ...
              <Card>
                  ...
                  <CardContent className="grid gap-4">
                      ...
                      <div className="flex items-center justify-between">
                          <div className="flex items-center gap-3">
                              <div className="p-2 bg-accent/20 rounded-full"><Activity className="h-5 w-5 text-accent" /></div>
